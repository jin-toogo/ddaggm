...
interface StructuredDataProps {
  type: 'website' | 'medical-business' | 'hospital' | 'non-payment';
  data?: any;
}
  ...
  switch (type) {
    case 'website':
      structuredData = {
        ...
        "@type": "WebSite",
        "name": "한의원 보험 적용 확인",
        "description": "한의원명으로 보험 적용 여부를 쉽게 확인할 수 있는 서비스입니다. 한방 첩약 보험 적용 정보를 제공합니다.",
    ...
    case 'medical-business':
      structuredData = {
        ...
        "description": "전국 한의원의 보험 적용 여부와 비급여 진료 항목을 확인할 수 있는 의료 정보 플랫폼",
        "url": "https://ddaggm.com",
        "medicalSpecialty": [
          "한의학",
          "추나요법",
    ...
    case 'non-payment':
      structuredData = {
        ...
        "@type": "MedicalWebPage",
        "name": "한의원 비급여 진료 항목",
        "description": "한의원 비급여 진료 항목과 가격 정보를 확인할 수 있습니다.",
        "medicalAudience": {
          "@type": "Patient"
        },
        "about": {
